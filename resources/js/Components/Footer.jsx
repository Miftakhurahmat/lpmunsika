            ...
            <div className="flex justify-evenly pt-5">
                <a href="https://instagram.com/lpmunsika" target="_blank">
                    <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-instagram transition ease-in-out duration-300 hover:text-pink-500"
                        viewBox="0 0 16 16"
                    >
                ...
                >
                    <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-youtube transition ease-in-out duration-300 hover:text-red-500"
                        viewBox="0 0 16 16"
                    >
                ...
                >
                    <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-spotify transition ease-in-out duration-300 hover:text-green-500"
                        viewBox="0 0 16 16"
                    >
                ...
                <a href="https://twitter.com/lpmunsika" target="_blank">
                    <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-twitter transition ease-in-out duration-300 hover:text-cyan-500"
                        viewBox="0 0 16 16"
                    >
                ...
                <a href="https://facebook.com/lpmunsika" target="_blank">
                    <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-facebook transition ease-in-out duration-300 hover:text-blue-500"
                        viewBox="0 0 16 16"
                    >
