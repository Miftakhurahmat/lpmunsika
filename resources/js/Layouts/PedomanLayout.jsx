                ...
                <article>
                    <figcaption className="text-justify">
                        ...
                        <p className="pt-5">
                            ...
                            dilaksanakan secara profesional, memenuhi fungsi,
                            hak, dan kewajibannya sesuai Undang-Undang Nomor 40
                            Tahun 1999 tentang Pers dan Kode Etik Jurnalistik.
                            Untuk itu Dewan Pers bersama organisasi pers,
                            pengelola media siber, dan masyarakat menyusun
                        ...
                        <ol className="pt-5 list-decimal pl-5">
                            ...
                            <p>
                                ...
                                yang ditetapkan Dewan Pers. Isi Buatan Pengguna
                                (User Generated Content) adalah segala isi yang
                                dibuat dan atau dipublikasikan oleh pengguna
                                media siber, antara lain, artikel, gambar,
                                komentar, suara, video dan berbagai bentuk
                            ...
                            <ol className="list-disc pl-5">
                                ...
                                <ol className="list-decimal pl-5">
                                    ...
                                    <li>
                                        ...
                                        yang jelas disebutkan identitasnya,
                                    ...
                                    <li>
                                        ...
                                        Penjelasan dimuat pada bagian akhir dari
                                        berita yang sama, di dalam kurung dan
                                        menggunakan huruf miring.
                                    </li>
                                </ol>
                                <li>
                                    Setelah memuat berita sesuai dengan butir
                                    (c), media wajib meneruskan upaya
                            ...
                            <ol className="list-disc pl-5">
                                ...
                                <li>
                                    ...
                                    siber wajib menyediakan mekanisme pengaduan
                                    Isi Buatan Pengguna yang dinilai melanggar
                                    ketentuan pada butir (c). Mekanisme tersebut
                                    harus disediakan di tempat yang dengan mudah
                            ...
                            <p>
                                ...
                                Pemberitaan Media Siber ini di medianya secara
                                terang dan jelas.
                            </p>
